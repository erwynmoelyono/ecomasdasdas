...
class WC_POS_Email_End_Of_Day_Report extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'End of Day Report', 'woocommerce-point-of-sale' );
		$this->description    = __( 'End of day reports are sent to chosen recipient(s) when a register is closed.', 'woocommerce-point-of-sale' );
