...
class WC_POS_Post_Types {
	...
	public static function init() {
		...
		add_action( 'wc_pos_after_register_post_type', array( __CLASS__, 'maybe_flush_rewrite_rules' ) );
		add_action( 'wc_pos_installed', array( __CLASS__, 'flush_rewrite_rules' ) );
	}
	...
	public static function register_post_types() {
		...
		if ( ! post_type_exists( 'pos_temp_order' ) ) {
			wc_register_order_type(
				'pos_temp_order',
				apply_filters(
					'wc_pos_register_post_type_pos_temp_order',
					array(
						'capability_type'                  => 'shop_order',
						'public'                           => false,
						'hierarchical'                     => false,
