...
<div id="message" class="updated">
	...
	<p class="submit"><a href="<?php echo esc_url( add_query_arg( 'do_update_wc_pos', 'true', admin_url( 'admin.php?page=wc-pos-settings' ) ) ); ?>" class="wc-update-now button-primary"><?php esc_html_e( 'Run the updater', 'woocommerce-point-of-sale' ); ?></a></p>
</div>
