...
<!-- Number of Copies -->
<li class="customize-control customize-control-select">
	<label class="customize-control-title" for="no_copies"><?php esc_html_e( 'Number of Copies', 'woocommerce-point-of-sale' ); ?></label>
	...
	<select id="no_copies" name="no_copies">
		<option value="1" <?php selected( $receipt_object->get_no_copies( 'edit' ), 1, true ); ?>><?php echo esc_html_x( '1', 'Receipt number of copies', 'woocommerce-point-of-sale' ); ?></option>
		<option value="2" <?php selected( $receipt_object->get_no_copies( 'edit' ), 2, true ); ?>><?php echo esc_html_x( '2', 'Receipt number of copies', 'woocommerce-point-of-sale' ); ?></option>
		<option value="3" <?php selected( $receipt_object->get_no_copies( 'edit' ), 3, true ); ?>><?php echo esc_html_x( '3', 'Receipt number of copies', 'woocommerce-point-of-sale' ); ?></option>
		<option value="4" <?php selected( $receipt_object->get_no_copies( 'edit' ), 4, true ); ?>><?php echo esc_html_x( '4', 'Receipt number of copies', 'woocommerce-point-of-sale' ); ?></option>
		<option value="5" <?php selected( $receipt_object->get_no_copies( 'edit' ), 5, true ); ?>><?php echo esc_html_x( '5', 'Receipt number of copies', 'woocommerce-point-of-sale' ); ?></option>
	</select>
</li>
