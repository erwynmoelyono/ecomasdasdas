...
class WC_POS_Report_Sales_By_Cashier extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			...
			'title'            => sprintf( __( '%s gross sales', 'woocommerce-point-of-sale' ), '<strong>' . wc_price( $data->total_sales ) . '</strong>' ),
		...
		$legend[] = array(
			...
			'title'            => sprintf( __( '%s net sales', 'woocommerce-point-of-sale' ), '<strong>' . wc_price( $data->net_sales ) . '</strong>' ),
	...
	public function current_filters() {
		...
		echo '<p><a class="button" href="' . esc_url( remove_query_arg( 'cashier_ids' ) ) . '">' . esc_html__( 'Reset', 'woocommerce-point-of-sale' ) . '</a></p>';
	}
	...
	public function products_widget() {
		?>
		<h4 class="section_title"><span><?php esc_html_e( 'Search Cashier', 'woocommerce-point-of-sale' ); ?></span></h4>
		<div class="section">
			<form method="GET">
				<div>
					<select class="wc-product-search" style="width:203px;" name="cashier_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a cashier&hellip;', 'woocommerce-point-of-sale' ); ?>" data-action="wc_pos_json_search_cashier"> </select>
		...
		<h4 class="section_title"><span><?php esc_html_e( 'Top cashiers', 'woocommerce-point-of-sale' ); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
				...
				if ( $top_sellers ) {
					...
					echo '<tr><td colspan="3">' . esc_html__( 'No cashiers found in range', 'woocommerce-point-of-sale' ) . '</td></tr>';
				}
				?>
			</table>
		</div>
	...
	public function get_main_chart() {
		...
		if ( ! $this->cashier_ids ) {
			...
			<div class="chart-container">
				<p class="chart-prompt"><?php esc_html_e( '&larr; Choose a cashier to view stats', 'woocommerce-point-of-sale' ); ?></p>
			</div>
			<?php
		} else {
