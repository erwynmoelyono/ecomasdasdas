...
class WC_POS_Paymentsense {
	...
	public static function params( $params ) {
		$paymentsense_data = get_option( 'woocommerce_pos_paymentsense_settings', array() );

		$params['paymentsense_host_address']      = isset( $paymentsense_data['host_address'] ) ? set_url_scheme( esc_url( $paymentsense_data['host_address'] ), 'https' ) : '';
		$params['paymentsense_api_key']           = isset( $paymentsense_data['api_key'] ) ? $paymentsense_data['api_key'] : '';
		$params['paymentsense_installer_id']      = isset( $paymentsense_data['installer_id'] ) ? $paymentsense_data['installer_id'] : '';
		$params['paymentsense_software_house_id'] = isset( $paymentsense_data['software_house_id'] ) ? $paymentsense_data['software_house_id'] : '';
