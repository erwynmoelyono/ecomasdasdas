		...
		$pid = wp_insert_post(
			array(
				...
				'meta_input'  => array(
					...
					'no_copies'                      => $receipt->print_copies_count,
...
if ( isset( $default_outlet ) && empty( get_user_meta( get_current_user_id(), 'outlet', true ) ) ) {
	update_user_meta( get_current_user_id(), 'outlet', array( (string) $default_outlet ) );
}
